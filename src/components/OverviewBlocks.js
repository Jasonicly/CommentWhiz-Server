            ...
            <div className="flex justify-center mt-4 p-2">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
                    <div className="bg-custom-green px-2 my-5 mx-2 min-w-[150px] rounded-lg flex flex-col justify-center-black text-white">
                        ...
                        <span className="text-3xl font-bold text-left ml-2">{summary["Total Review Count"]}</span>
                    ...
                    <div className="bg-custom-green px-2 my-5 mx-2 min-w-[150px] rounded-lg flex flex-col justify-center-black text-white">
                        ...
                        <span className="text-3xl font-bold text-left ml-2">{summary["ProductRating"]} / 5 <span className="text-lg">stars</span></span>
                    ...
                    <div className="bg-custom-green px-2 my-5 mx-2 min-w-[150px] rounded-lg flex flex-col justify-center-black text-white">
                        ...
                        <span className="text-3xl font-bold text-left ml-2">{summary["Number of Reviews"]} / {summary["Total Review Count"]}</span>
