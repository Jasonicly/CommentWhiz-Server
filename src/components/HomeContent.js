    ...
    return (
        <div className="container mx-auto py-16 px-4">
            <div className="p-8 max-w-3xl mx-auto">
                <h3 className="text-4xl font-bold mb-6 text-center p-5">About Comment Whiz's Review Analysis Extension</h3>
                ...
                <p className="text-xl text-center font-semibold">
                    Summarized Reports . Sentiment Analysis . Bot Detection . Key Topics Highlighted . User-Friendly Interface
                </p>
            </div>
        </div>
    );
